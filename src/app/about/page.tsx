        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="glass bg-yellow-100 p-4 rounded-lg shadow-lg backdrop-filter backdrop-blur-lg dark:bg-opacity-30 mb-12">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="w-full md:w-1/2 lg:w-5/12 rounded-lg overflow-hidden">
                        <Image priority src={Pic1} alt="Car Image" layout="responsive" width={700} height={475} />
                    </div>
            ...
            <div className="glass bg-yellow-100 p-4 rounded-lg shadow-lg backdrop-filter backdrop-blur-lg dark:bg-opacity-30 mb-12">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 flex-row-reverse">
                    <div className="w-full md:w-1/2 lg:w-5/12 rounded-lg overflow-hidden">
                        <Image priority src={Pic2} alt="Simple Car" layout="responsive" width={700} height={475} />
                    </div>
                    <div className="w-full md:w-1/2 lg:w-6/12">
            ...
            <div className="glass bg-yellow-100 p-4 rounded-lg shadow-lg backdrop-filter backdrop-blur-lg dark:bg-opacity-30 mb-12">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="w-full md:w-1/2 lg:w-5/12 rounded-lg overflow-hidden">
                        <Image priority src={Pic3} alt="Classic Car" layout="responsive" width={700} height={475} />
                    </div>
                    <div className="w-full md:w-1/2 lg:w-6/12">
